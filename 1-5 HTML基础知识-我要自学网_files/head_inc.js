...
//***
// 查看调查
function J_ViewPoll(id) {
	window.open("http://www.51zxw.net/"+"pollView.aspx?act=result&id="+id, "iwmsPoll","width=500,height=400,left=0,top=0,scrollbars=1,status=1,resizable=1");
}
//***
